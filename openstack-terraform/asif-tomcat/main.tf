...
#    command                = "sleep 45 && ansible-playbook -i '${openstack_networking_floatingip_v2.fip1.address},' -e 'ansible_python_interpreter=/usr/bin/python3' --private-key=~/.ssh/id_rsa playbook.yml"
#   }
}
